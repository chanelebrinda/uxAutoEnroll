...
?>
   <div class="ux-order-subcription">  
      ...
      <div> 
         <h1 class="ux-entry-title"><?php // _e('Valider ma commande ','ux-autoaenroll') ?></h1> 
     </div>
            ...
            <div class="uxp__checkout"> 
              <div class="uxp-billing-item">
                <div class="ux_subcrition_billing_fields">
                  ...
                  <h3><?php _e('Détails de la commande','ux-autoaenroll') ?> </h3>

                  <div class="ux_subcrition-billing-fields__field-wrapper">
                      <div class="row g-3">
                      <h5 class="uxp_company_information"><?php _e('Informations personnelles','ux-autoaenroll') ?></h5>

                        <div class="col-sm-6">
                          <label for="uxp_firstName" class="form-label"><?php _e('Nom','ux-autoaenroll')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small></label>
                          <input type="text" class="form-control" id="uxp_firstName" placeholder="" value="" required>
                        </div>

                        <div class="col-sm-6">
                          <label for="uxp_lastName" class="form-label"><?php _e('Prénom','ux-autoaenroll')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small></label>
                       ...
                       <div class="col-sm-6">
                          ...
                          <div class=" invalid-text" id="email_error" style="color:#ca0000;font-weight:500;font-size: 13px;text-align:left">
                            <?php _e('Vous devez entrer un courriel professionnel ex:john@example.com','ux-autoaenroll')?>
                          </div>
                        </div>  
                        <div class="col-sm-6">
                          <label for="uxp_telephone" class="form-label"><?php _e('Téléphone','ux-autoaenroll')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small></label>
                          ...
                          <div class=" invalid-text" id="phone_error" style="color:#ca0000;font-weight:500;font-size: 13px;text-align:left">
                            <?php _e('Vous devez entrer un numéro de téléphone valide ex:+1 418 264 0300,14182640300','ux-autoaenroll')?>
                          </div>
                        </div>

                        <h5 class="uxp_company_information"><?php _e('Informations de l\'entreprise','ux-autoaenroll') ?></h5>

                        <div class="col-sm-12">
                          <label for="uxp_lmsPortalName" class="form-label"><?php _e('Nom de l\'entreprise')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small></label>
                          ...
                          <div class="invalid-text" id="uxp_lmsPortalName_error" style="color:#ca0000;font-weight:500;font-size: 13px;text-align:left">
                            <?php _e('Vous devez entrer un nom sans caractère spéciaux ex:Example website ou example-wesite','ux-autoaenroll')?>
                          </div>
                        </div>
                       ...
                       <div class="col-sm-6">
                          ...
                          <div class="invalid-text" id="uxp_email_error" style="color:#ca0000;font-weight:500;font-size: 13px;text-align:left">
                            <?php _e('Vous devez entrer un courriel professionnel ex:john@exemple.com','ux-autoaenroll')?>
                          </div>
                        </div> 
                        

                        <div class="col-sm-6">
                          <label for="uxp_lmsPortalPhoneNumber" class="form-label"><?php _e('Téléphone','ux-autoaenroll')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small></label>
                        ...
                        <div class="col-sm-6">
                          <label for="uxp_addressLine1" class="form-label"><?php _e('Adresse ligne 1','ux-autoaenroll')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small></label>
                          <input type="text" class="form-control" id="uxp_addressLine1" placeholder="" >
                        </div>
                        <div class="col-sm-6">
                          <label for="uxp_addressLine2" class="form-label"><?php _e('Adresse ligne 2','ux-autoaenroll')?></label>
                        ...
                        <div class="col-sm-6">
                          <label for="uxp_country" class="form-label"><?php _e('Pays','ux-autoaenroll')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small></label>   
                          <select id="uxp_country" class="form-select form-select-sm mb-3 uxp_country" aria-label=".form-select-sm example" required>
                            <option value=""><?php _e('sélectionnez','ux-autoaenroll')?></option>
                            <?php 
                        ...
                        <div class="col-sm-6">
                          <label for="uxp_city" class="form-label"><?php _e('Ville','ux-autoaenroll')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small></label>
                          <input type="text" class="form-control" id="uxp_city" placeholder="">
                        </div>

                        <div class="col-sm-6">
                          <label for="uxp_zipCode" class="form-label"><?php _e('Code postal','ux-autoaenroll')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small></label>
                          <input type="text" class="form-control" name="uxp_zipCode"  id="uxp_zipCode" placeholder="" required>
                           ...
                           <?php _e('Vous devez entrez un code correct','ux-autoaenroll')?>
                          </div>
                        </div>   
                        <div class="col-sm-12">
                          <label for="uxp_companyWebsite" class="form-label"><?php _e('Site web de l\'entreprise','ux-autoaenroll')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small></label>
                          <input type="text" class="form-control" name="uxp_companyWebsite" id="uxp_companyWebsite" placeholder="www.example.com" required>
                           <div class="invalid-text" id="uxp_website" style="color:#ca0000;font-weight:500;font-size: 13px;text-align:left">
                            <?php _e('Vous devez entrez une url correcte "www.exemple.com ou exemple.com"','ux-autoaenroll')?>
                          </div>
                        </div>
                        <div class="col-sm-12 "> 

                          <label for="uxp_lmsPortalSubdomain" class="form-label"><?php _e(' Sous-domaine','ux-autoaenroll')?><small class="text-mute" style="color:#6a4d93;padding-left:2px"> *</small>
                        <small  class="ux_tooltip">
                           <small  data-title="Le sous-domaine sera l'URL utilisé pour votre plateforme LMS" >
              ...
              <div class="uxp-order-item">
                ...
                <h3 id="order_review_heading"><?php _e('Votre commande','ux-autoaenroll')?></h3>
                  ...
                  <table class="shop_table ux_subcrition-checkout-review-order-table">
                    ...
                    <tfoot>
                      ...
                      <tr class="cart-subtotal">
                        <th><?php _e('Sous-total','ux-autoaenroll')?></th>
...
<!--                   
                      <tr class="order-total recurring-total">
                        ...
                        <th rowsmall="1">Total récurrent'</th>
                        <td data-title="Recurring total">
                          <div class="first-payment-date"><small>Renouvellement dans un <small class="uxp_plan_recurence"> </small></div><small
